      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {courses.map((c) => (
            <div
              key={c.id}
              className="group overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-card dark:border-neutral-800 dark:bg-neutral-900"
            >
              ...
              <div className="p-5">
                ...
                <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400 line-clamp-2">{c.description}</p>
                ...
                <button className="btn-black mt-4 w-full rounded-xl">
                  Continue learning
                </button>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-card dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="mt-5 space-y-3">
              {assignments.map((a) => (
                <div
                  key={a.id}
                  className="flex items-center justify-between rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-4 dark:border-neutral-800 dark:bg-neutral-800/50"
                >
                  <div>
                  ...
                  <button className="btn-black rounded-lg px-3 py-1.5 text-xs">
                    Take exam
                  </button>
                </div>
              ))}
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-card dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="mt-5 space-y-3">
              {certificates.map((c) => (
                <div
                  key={c.id}
                  className="flex items-center gap-4 rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-4 dark:border-neutral-800 dark:bg-neutral-800/50"
                >
