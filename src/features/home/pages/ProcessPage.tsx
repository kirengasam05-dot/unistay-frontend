...
const steps = [
  {
    ...
    description: 'Sign up as a Student or Host. Employer and Admin accounts are created internally by platform administrators for security.',
    tag: 'Getting started',
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    description: 'Employers publish opportunities with skill requirements. Students apply and employers review compatibility based on their course certificates.',
    tag: 'Jobs',
  },
  {
    icon: BookOpen,
    title: 'Study, take exams & earn certificates',
    description: 'Employers upload courses, videos, materials and exams. Students complete them to earn certificates that boost their job match score.',
    tag: 'Skills',
  },
  {
    icon: ShieldCheck,
    title: 'Admin manages the platform',
    description: 'Admins oversee users, roles, verifications, learning content, analytics and moderation to keep the platform safe and effective.',
    tag: 'Administration',
  },
];
...
export default function ProcessPage() {
  return (
    <div className="dark:bg-neutral-950">
      {/* hero */}
      <section className="border-b border-neutral-200 bg-neutral-950 px-4 py-20 text-white dark:border-neutral-800 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <p className="eyebrow text-neutral-400">How it works</p>
          <h1 className="mt-4 text-4xl font-black leading-tight sm:text-5xl">
            Everything you need,<br />in five simple steps.
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-base text-neutral-400">
            UniStay+ connects students, hosts, employers and admins in one seamless ecosystem — from room search to career readiness.
          </p>
              ...
              return (
                <div key={step.title} className="relative flex gap-6 sm:gap-8">
                  ...
                  <div className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border-2 border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-900 sm:h-16 sm:w-16">
                    <Icon size={20} className="text-neutral-700 dark:text-neutral-300 sm:hidden" />
                    <Icon size={24} className="hidden text-neutral-700 dark:text-neutral-300 sm:block" />
                  </div>
                  ...
                  <div className="flex-1 pb-2 pt-1">
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <span className="rounded-full bg-neutral-100 px-3 py-0.5 text-xs font-semibold text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400">
                        {step.tag}
                      </span>
                    </div>
                    <h2 className="mt-2 text-xl font-black text-neutral-900 dark:text-white sm:text-2xl">
                      {step.title}
                    </h2>
