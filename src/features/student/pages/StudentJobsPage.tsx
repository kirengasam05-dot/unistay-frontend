...
import { MapPin, Wallet, Clock3 } from 'lucide-react';
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="mt-2 flex flex-wrap gap-4 text-sm text-neutral-500 dark:text-neutral-400">
                  ...
                  <span className="flex items-center gap-1"><Wallet size={13} />RWF {j.salary.toLocaleString()}</span>
                </div>
              ...
              {applied.includes(j.id) ? (
                ...
                <button
                  onClick={() => setApplied([...applied, j.id])}
                  className="btn-black shrink-0 rounded-xl"
                >
                  Apply now
                </button>
              )}
